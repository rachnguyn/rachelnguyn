    ...
    <div className="container">
      ...
      <main>
        <div className="grid card text-center">
          ...
          <p>
          <a href="mailto: rachelnguyn@gmail.com" target="_blank">
              <p className="link">email  &rarr;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          </a>
          <a href="https://github.com/rachnguyn" target="_blank">
        ...
        <div className="card">
          <div className="text-right grid card">
            ...
            <a href="https://github.com/rachnguyn/turtlemania" target="_blank">
              <br></br><p className="link">explore &rarr;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            </a>
            <a href="https://rachnguyn.github.io/turtlemania/" target="_blank">
          ...
          <div className="text-right grid card">
            ...
            <a href="https://github.com/rachnguyn/dotnet/tree/main/Employee_Directory_App" target="_blank">
              <br></br><p className="link">explore &rarr;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            </a>
          </div>
          ...
          <div className=" text-right grid card">
            ...
            <a href="https://github.com/rachnguyn/dotnet/tree/main/To_Do_App" target="_blank">
              <br></br><p className="link">explore &rarr;&nbsp;&nbsp;&nbsp;&nbsp;</p>
            </a>
          </div>
        </div>
